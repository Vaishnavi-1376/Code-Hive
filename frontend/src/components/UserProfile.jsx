          ...
          <form onSubmit={handleUpdate} className="text-left px-4 md:px-8">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                readOnly 
                className="shadow appearance-none border rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-blue-500 bg-gray-100 cursor-not-allowed" // Added styles for read-only look
